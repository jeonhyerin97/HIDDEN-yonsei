...
.modal-body{padding:24px;max-height:calc(90vh - 140px);overflow:auto}
.modal-body iframe{width:100%;height:70vh;border:1px solid #2a2a2a;border-radius:8px;background:#fff}
.modal-footer{
...
<div class="toolbar">
  ...
  <div class="toolbar-group" style="border:none">
    <button class="btn" onclick="openPreview()"><span class="btn-icon">👁</span> 미리보기</button>
