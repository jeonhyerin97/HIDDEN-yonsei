...
예시 URL: https://github.com/jeonhyerin97/HIDDEN-yonsei.git
"""
...
def main():
    ...
    if not git_dir.exists():
        ...
        print("\n[0.5/5] 첫 커밋 생성 중...")
        run_git("add", "-A")
        run_git("commit", "-m", "Initial commit: HIDDEN Yonsei Portfolio")
        print()
    ...
    print("예시: https://github.com/jeonhyerin97/HIDDEN-yonsei.git")
    print()
    ...
    if success or "Everything up-to-date" in stderr:
        ...
        print("- 자동으로 hidden-yonsei.com에 반영됩니다!")
    else:
        print("  [FAILED] 푸시 실패")
        print("="*60)
        print()
